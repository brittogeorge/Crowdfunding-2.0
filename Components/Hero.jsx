          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                <span className="mos">
                COSMOS </span> <br className="hidden md:block"/> 
                Innovate with Us, Invest in Progress !!
              
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                <span className="">
                Here you can initiate a campaign and also you can reach yooung minds who wishes to transform their vision to action and donate them directly through cryptocurrency !! Bring a creative project to Life.
                </span>
